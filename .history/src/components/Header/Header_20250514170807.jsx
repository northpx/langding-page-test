          ...
          <div className="flex gap-6 items-center flex-shrink-0">
            ...
            <ul className="hidden lg:flex text-[#D2D2D2]">
              {menuLink.map((item) => {
                return (
                  <li
                    className="relative px-[18px] py-[10px] uppercase text-sm leading-5 font-medium first:text-[#FFC700] first:bg-[#383A42] rounded-full block after:block after:content-[''] after:absolute after:h-[3px] after:bg-yellow-300 after:w-full after:scale-x-0 hover:after:scale-x-100 after:transition-all after:duration-300 after:origin-center"
                    key={item.id}
                  >
                    {item.name}
                  </li>
