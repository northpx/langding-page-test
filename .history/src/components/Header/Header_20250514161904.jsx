  ...
  return (
    <nav className="z-50">
      <div className="container mx-auto relative ">
        ...
        {/* {mobile link} */}
        {isOpenMenu && (
          <div className="absolute top-[100%] h-screen bg-[#1F2023] w-full z-100 mx-auto ">
            <ul className=" right-0 z-20 flex flex-col justify-center items-center gap-2 lg:hidden text-white px-10 bg-[#1F2023]">
              {menuLink.map((item) => {
                return (
                  <li key={item.id} className="w-full mx-auto text-center border">
                    {item.name}
                  </li>
                );
              })}
