            ...
            >
              {menuLink.map((item) => {
                return (
                  <li
                    key={item.id}
                    className="w-full mx-auto text-center rounded-full px-5 py-[14px] text-sm leading-5 font-medium uppercase first:text-[#FFC700] first:bg-[#383A42] hover:bg-[#383A42] hover:text-[]"
                  >
                    {item.name}
                  </li>
                );
