      ...
      <div className="container mx-auto relative ">
        ...
        <div className="flex items-center justify-between px-5 py-3 md:py-5 md:px-10">
          ...
          <div className="flex gap-2">
            <button className="disabled:opacity-40 border-none outline-none bg-[#FFC700] rounded-full px-6 py-2 md:px-8 md:py-3 cursor-pointer hover:bg-[#C79B12] transition-all duration-500" disabled>
              <h6 className="uppercase font-black italic text-[#1F1F1F] text-[16px] leading-6">
                sign up
              </h6>
            </button>
            <button className="disabled:opacity-40 border outline-none rounded-full  px-6 py-2 md:px-8 md:py-3 border-[#FFC700] cursor-pointer hover:border-[#FFE8AB] transition-all duration-500">
