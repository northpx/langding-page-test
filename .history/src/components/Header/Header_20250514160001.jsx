      ...
      <div className="container  mx-auto relative px-5 py-3 md:py-5 md:px-10">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button className="border-none outline-none bg-[#FFC700] rounded-full ">
              <h6 className="uppercase px-6 py-2 md:px-8 md:py-3 font-[900] italic text-[#1F1F1F] text-[16px] leading-6">sign up</h6>
            </button>
