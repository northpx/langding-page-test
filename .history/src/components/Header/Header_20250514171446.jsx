          ...
          <div className="flex gap-6 items-center flex-shrink-0">
            ...
            <ul className="hidden lg:flex gap-1 text-[#D2D2D2]">
              {menuLink.map((item) => {
                return (
                  <li
                    className="relative px-[18px] py-2 uppercase text-sm leading-5 font-medium first:text-[#FFC700] first:bg-[#383A42] rounded-full cursor-pointer hover:text-[#FFC700] hover:bg-[#383A42] tran"
                    key={item.id}
                  >
                    {item.name}
                  </li>
