      ...
      <div className="container max-w-full relative">
        ...
        <div className="flex items-center justify-between px-5 py-3 md:py-5 md:px-10">
          ...
          <div className="flex gap-6 items-center flex-shrink-0">
            <div className="flex gap-4 items-center justify-center">
              ...
              >
                ...
                {isOpenMenu ? <IoClose className="text-3xl md:text-4xl"/> : <HiMenuAlt2  className="text-3xl md:text-4xl"/>}
              </div>
              <img
                src={logo}
                alt=""
                className="w-auto h-8 object-cover overflow-hidden cursor-pointer"
              />
            </div>
            {/* {pc links} */}
          ...
          <div className="flex gap-2">
            ...
            <button className="disabled:opacity-40 disabled:hover:cursor-not-allowed border-[1px] outline-none rounded-full  px-6 py-2 md:px-8 md:py-3 border-[#FFC700] cursor-pointer hover:border-[#FFE8AB] transition-all duration-500" disabled>
        ...
        {/* {mobile link} */}
        {isOpenMenu && (
          <div className="absolute top-[100%] h-screen bg-[#1F2023] w-full md:w-full z-20 mx-auto p-5 lg:hidden">
            <ul
