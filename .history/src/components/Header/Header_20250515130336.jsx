...
const Header = () => {
  ...
  return (
    <nav className="z-50">
      <div className="containerư mx-auto relative">
        {/* {navbar} */}
          ...
          <div className="flex gap-6 items-center flex-shrink-0">
            <div className="flex gap-4 items-center justify-center">
              ...
              >
                ...
                {isOpenMenu ? <IoClose size={30} /> : <HiMenuAlt2 size={30} />}
              </div>
              <img
                src={logo}
                alt=""
        ...
        {/* {mobile link} */}
        {isOpenMenu && (
          <div className="absolute top-[100%] h-screen bg-[#1F2023] md:w-full z-20 mx-auto p-5 lg:hidden">
            <ul
