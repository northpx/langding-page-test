      ...
      <div className="container mx-auto relative ">
        ...
        <div className="flex items-center justify-between px-5 py-3 md:py-5 md:px-10">
          ...
          <div className="flex gap-2">
            ...
            <button className="disabled:opacity-40 border outline-none rounded-full  px-6 py-2 md:px-8 md:py-3 border-[#FFC700] cursor-pointer hover:border-[#FFE8AB] transition-all dura">
