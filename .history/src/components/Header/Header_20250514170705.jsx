      ...
      <div className="container mx-auto relative ">
        ...
        <div className="flex items-center justify-between px-5 py-3 md:py-5 md:px-10">
          ...
          <div className="flex gap-6 items-center flex-shrink-0">
            ...
            {/* {pc links} */}
            <ul className="hidden lg:flex text-[#D2D2D2]">
              {menuLink.map((item) => {
                return (
                  <li
                    className="px-[18px] py-[10px] uppercase text-sm leading-5 font-medium first:text-[#FFC700] first:bg-[#383A42] rounded-full after:block after:content-[''] after:absolute after:h-[3px] after:bg-yellow-300 after:w-full after:scale-x-0 hover:after:scale-x-100 after:transition-all after:duration-300 after:origin-center"
                    key={item.id}
                  >
                    {item.name}
                  </li>
