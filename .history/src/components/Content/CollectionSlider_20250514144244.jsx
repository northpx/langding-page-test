  ...
  return (
    <section className="flex flex-col gap-2">
      <div className="flex justify-between items-center">
        <h3 className="italic font-[900] text-[#FFC700] text-2xl leading-8 uppercase tracking-tight">
          New Nft Collections
        </h3>
        <div className="flex gap-2">
          ...
          <a
            ...
            className="p-1 md:p border-none rounded-md md:rounded-[12px] outline-none bg-[#383A42]"
          >
