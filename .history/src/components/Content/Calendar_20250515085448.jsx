...
import imageContent2 from "../../assets/image (1).png";
import imageContent3 from "../../assets/image (1).png";
...
const Calendar = () => {
  ...
  return (
    <section className="max-w-full px-5 md:px-59 pb-10 md:pb-20 border border-white">
      <div className="max-w-full border border-white ">
