...
const Calendar = () => {
  ...
  return (
    <section className="max-w-full px-5 md:px-10 lg:px-59 pb-10 md:pb-15 lg:pb-20">
      <div className="max-w-full">
        <div className="flex flex-col gap-6 md:flex-col md:gap-15 lg:flex-row lg:gap-6">
                  ...
                  <SwiperSlide className="">
                    <div className="overflow-hidden rounded-lg">
                      <img
                        src={imageContent1}
                        alt=""
                        className="w-full h-[171px] md:h-60 object-cover md:object-top hover:scale-105 transition-all duration-200"
                      />
                    </div>
                  </SwiperSlide>
                </Swiper>
