...
const Footer = () => {
    return (
        <section className='w-[full] mx-auto border-t-[1px] border-[#383A42] py-10 px-5 md:px-[236px] md:py-10'>
            <div className='grid grid-cols-2 gap-x-4 gap md:grid md:grid-cols-4 md:gap-10'>
                <div className='border flex flex-col gap-3'>
                    <h5 className='font-[900] italic text-lg leading-7 uppercase'>About us</h5>
                    <ul className='flex flex-col gap-2'>
                        <li className='text-[12px] font-normal leading-4 md:text-sm md:leading-5 text-[#D2D2D2]'>Careers</li>
